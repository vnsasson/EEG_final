function Mat = fill_T_paper(Mat,Wave_Mat,p,freqReg,brainReg,frontal,central,post_occ,left,right,broca,wernick)
% a function that fills the matrix called Mat
% step by step with a dataset of paper subject

paper_T = zeros(freqReg,brainReg*2);

%% Filling of paper_T matrix
...
% i represent the current location on Mat for appending the paper_T matrix
i = 5*(p-1)+1;

Mat(i:i+4,1:2:13) = paper_T(1:5,1:2:13);
