...
[myDir,filepath_before,filepath_after,cap385,cap16,fs] = preprocessing_config();

% starting EEGLAB
[ALLEEG EEG CURRENTSET ALLCOM] = eeglab;  


%% preprocessing .vhdr files (63/64 electrodes)
...
%% preprocessing .ahdr files (16 electrodes)
...
for k = 1:length(myFiles_16)
  ...
  preprocessing_16_func(ALLEEG,baseFileName,fullFileName,filepath_before,filepath_after,cap385,cap16);  
end
