...
function [] = preprocessing_16_func(ALLEEG,baseFileName,fullFileName,filepath_before,filepath_after,cap385,cap16)
    ...
    %% 3- Reject artifact manually - working manually
